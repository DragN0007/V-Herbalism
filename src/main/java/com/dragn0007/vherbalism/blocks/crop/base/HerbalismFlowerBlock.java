...
public class HerbalismFlowerBlock extends BushBlock implements SuspiciousEffectHolder {
   ...
   public HerbalismFlowerBlock(MobEffect p_53512_, int p_53513_, BlockBehaviour.Properties p_53514_) {
      super(p_53514_);
