...
public class GarlicItem extends HerbalNameBlockItem {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.vherbalism.garlic.tooltip").withStyle(ChatFormatting.GRAY));
    }
}
