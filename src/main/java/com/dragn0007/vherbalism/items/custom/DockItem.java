...
public class DockItem extends HerbalNameBlockItem {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        pTooltipComponents.add(Component.translatable("tooltip.vherbalism.dock_leaf.tooltip").withStyle(ChatFormatting.GRAY));
    }
}
